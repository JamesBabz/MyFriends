...
public class Map_details extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void setSelectedFriend() {
        Bundle extras = getIntent().getExtras();
        friend = ((Friend) extras.getSerializable("FRIEND"));
    }

    private void createFriendMarker(List<Address> address) {
        LatLng location;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Toast.makeText(this, mLastLocation.toString(), Toast.LENGTH_LONG);
    }
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        System.out.println("TEST-CON FAILED");
